...
def get_response(user_input):
    ...
    if "what is" in processed_input_str:
        ...
        if query:
            ...
            return "Can you please specify what you want to know?"

    # Check patterns_responses dictionary for a match
    for pattern, response in patterns_responses.items():
        if pattern != "default" and pattern in processed_input_str:
            return response

    # Return the default fallback response if no pattern matched
